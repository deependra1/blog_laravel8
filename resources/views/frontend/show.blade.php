                ...
                <div class="col-lg-8 entries">
                    ...
                    <div class="blog-pagination">
                        <ul class="justify-content-center">
                            @isset($post->previous)
                            <li><a href="{{ route('posts.display', $post->previous->slug) }}">{{ $post->previous->title }} <i class='bx bxs-left-arrow-square bx-fade-right'></i> </a></li>
                            @endisset
                            @isset($post->next)
                            <li><a href="{{ route('posts.display', $post->next->slug) }}"><i class='bx bxs-right-arrow-square bx-fade-left'></i> {{ $post->next->title }} </a></li>
                            @endisset
